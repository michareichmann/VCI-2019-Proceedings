...
have slightly different properties. Due to that the size of the measured signal in \ac{pCVD} depends also on the spatial position as can be seen in \ar{sm}. However this behaviour is constant and does not depend on time or rate.\par
